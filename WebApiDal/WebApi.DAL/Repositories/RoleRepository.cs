...
namespace WebApi.DAL.Repositories
{
    public class RoleIntRepository : RoleRepository<int, RoleInt, UserInt, UserClaimInt, UserLoginInt, UserRoleInt>,
        IRoleIntRepository
    {
        public RoleIntRepository(HttpClient httpClient, string endPoint) : base(httpClient, endPoint)
        {
        }
    }

    public class RoleRepository : RoleRepository<string, Role, User, UserClaim, UserLogin, UserRole>, 
        IRoleRepository
    {
        public RoleRepository(HttpClient httpClient, string endPoint) : base(httpClient, endPoint)
        {
        }
    }
